...
INPUT_DIR = '/mnt/input'  # Dieser Pfad entspricht dem gemounteten Verzeichnis im Container
OUTPUT_DIR = '/mnt/output'  # Entspricht dem gemounteten Verzeichnis für die Ausgabe
