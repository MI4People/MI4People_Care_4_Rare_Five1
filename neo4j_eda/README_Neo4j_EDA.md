...
- some output files (queries_output.h5, similarities.csv) for exploratory data analysis on synthetic data (note: node_properties.csv can be generated by running "gds_exploration_mutate.py");
